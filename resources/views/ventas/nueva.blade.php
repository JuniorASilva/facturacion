                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            ...
                                            <input class="form-control" id="cantidad" name="cantidad" type="number" value="1" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <label>Precio</label>
                                            <input class="form-control" id="precio1" name="precio" type="number" step="0.001" value="0.000" required>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            <label>Tipo</label>
